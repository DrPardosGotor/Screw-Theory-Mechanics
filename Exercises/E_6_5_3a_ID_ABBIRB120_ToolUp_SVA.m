...
% with Th generalized joint positions, Thd velocities & Thdd accelerations.
%
...
%
%% E652b_ST24R_ID_ABBIRB120_ToolUp_CLAvSVA
%
clear;
clc;
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
po=[0;0;0]; pg=[0;0.19;0]; pk=[0;0.29;0]; pr=[0;0.56;0]; ps=[0;0.63;0];
...
% by Featherstone Spatial Toolbox 2016.
...
for i = 1:DoF
    ...
    Hs0 = trvP2tform(Point(:,i) - Pre) * Hs0;
