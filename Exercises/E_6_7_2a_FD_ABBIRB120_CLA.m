...
%
% The goal of this exercise is to prove the FORWARD DYNAMICS Classical
...
Thp = Thp*pi/180;
Tor = [(rand-rand)*Thp(1) (rand-rand)*Thp(2) (rand-rand)*Thp(3)];
Tor = [Tor (rand-rand)*Thp(4) (rand-rand)*Thp(5) (rand-rand)*Thp(6)];
TwMag = [Twist; Th];
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
