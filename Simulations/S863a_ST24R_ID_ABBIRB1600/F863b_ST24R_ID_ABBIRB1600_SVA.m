%% Function "F861a_ST24R_ID_ABBIRB1600_SVA" - Spatial Vector Algebra.
% ABB IRB 1600 - Robot HOME TOOL ahead.
...
%
% function TorOut = F863b_ST24R_ID_ABBIRB1600_SVA(u)
%
...
% F110_CreateToolTra_Trig([0.6 -0.3 0.6 0 pi/2 0], [0.9 0.3 0.9 pi/4 3*pi/4 pi/4], 0.001, 10)
%
...
%
%% F863b_ST24R_ID_ABBIRB1600_SVA
%
function TorOut = F863b_ST24R_ID_ABBIRB1600_SVA(u) % #codegen
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%po=[0;0;0];
pg=[0;0;0.2]; pk=[0.15;0;0.4865]; pr=[0.15;0;0.9615];
...
Tormax = [950 950 950 750 450 450];
Tormin = -[950 950 950 750 450 450];
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Reading INPUTS:
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
