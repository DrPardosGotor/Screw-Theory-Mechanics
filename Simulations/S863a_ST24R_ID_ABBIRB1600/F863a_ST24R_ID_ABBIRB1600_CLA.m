%% Function "F863a_ST24R_ID_ABBIRB1600_CLA"
...
%
% function TorOut = F863a_ST24R_ID_ABBIRB1600_CLA(u)
%
...
%
%% F863a_ST24R_ID_ABBIRB1600_CLA
%
function TorOut = F863a_ST24R_ID_ABBIRB1600_CLA(u) % #codegen
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Kp = 550 * KpWeight;
%KpWeight = [0.3, 0.8, 0.6, 0.6, 0.3, 0.2];
%
