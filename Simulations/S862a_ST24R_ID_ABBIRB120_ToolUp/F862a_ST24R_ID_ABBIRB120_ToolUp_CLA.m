%% Function "F862a_ST24R_ID_ABBIRB120_ToolUp"
...
%
% function TorOut = F862a_ST24R_ID_ABBIRB120_ToolUp_CLA(u)
%
...
%
%% F862a_ST24R_ID_ABBIRB120_ToolUp_CLA
%
function TorOut = F862a_ST24R_ID_ABBIRB120_ToolUp_CLA(u) % #codegen
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%po=[0;0;0];
pk=[0;0.290;0]; pr=[0;0.560;0]; pf=[0.302;0.630;0]; pp=[0.302;0.790;0];
