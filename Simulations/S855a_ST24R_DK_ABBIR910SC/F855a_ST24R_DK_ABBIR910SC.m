%% "F855a_ST24R_DK_ABBIR910SC" Scara Robot Differential Kinematics
% ABB IRB 910SC - Robot with complete dynamics.
%
...
%
% function ThetaOut = F855a_ST24R_DK_ABBIR910SC(u)
%
...
%
%% F855a_ST24R_DK_ABBIR910SC
%
function ThetaOut = F855a_ST24R_DK_ABBIR910SC(u) %#codegen
%
persistent ThetaVAL;
if isempty(ThetaVAL)
    ThetaVAL = zeros(1,4);
