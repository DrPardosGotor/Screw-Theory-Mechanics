%% Function "F865b_ST24R_ID_ABBIRB910SC_SVA" - Spatial Vector Algebra.
...
%
% function TorOut = F865b_ST24R_ID_ABBIRB910SC_SVA(u)
%
...
%
%% F865b_ST24R_ID_ABBIRB910SC_SVA
%
function TorOut = F865b_ST24R_ID_ABBIRB910SC_SVA(u) % #codegen
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Position of the Tool to the previous Link FrameHs0 = Hs0 * trvP2tform(pp - Pre) * rotY2tform(pi);
Hsi = PoE * Hs0;
