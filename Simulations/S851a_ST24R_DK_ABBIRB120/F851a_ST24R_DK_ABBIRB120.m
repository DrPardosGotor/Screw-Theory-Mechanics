%% "F851a_ST24R_DK_ABBIRB120" PUMA Robot Differential Kinematics
...
%
% function ThetaOut = F851a_ST24R_DK_ABBIRB120(u)
%
...
%
%% F851a_ST24R_DK_ABBIRB120
%
function ThetaOut = F851a_ST24R_DK_ABBIRB120(u) %#codegen
%
persistent ThetaVAL;
if isempty(ThetaVAL)
    ThetaVAL = zeros(1,6);
