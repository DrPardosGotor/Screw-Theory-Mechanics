%% Function "F864a_ST24R_ID_ABBIRB6620LX_CLA"
% ABB IRB 6620LX - Robot HOME tool ahead.
...
%
% function TorOut = F864a_ST24R_ID_ABBIRB6620LX_CLA(u)
%
...
% "JointVAL"(9..14) = TheVAL Feedback of actual joints POSITIONS.
% "JointpVAL"(15..20) = ThepVAL Feedback actual joints VELOCITIES.
%
% OUTPUTS:
% "TorOut" (t1..t6) are the FORCE (t1) & TORQUES solution for Joints1..6.
%
...
%
% Example of random trajectory generation for AUTOMATIC input testing.
% F110_CreateToolTra_Trig([0.5 1 0.5 0 pi/2 0], [0.7 3 2.5 pi/4 3*pi/4 pi/4], 0.001, 10)
%
...
%
%% F864a_ST24R_ID_ABBIRB6620LX_CLA
%
function TorOut = F864a_ST24R_ID_ABBIRB6620LX_CLA(u) % #codegen
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%po=[0;0;0]; 
pu=[1.088;2.500;0]; % even though "pu" has not use because Theta1=TRA
