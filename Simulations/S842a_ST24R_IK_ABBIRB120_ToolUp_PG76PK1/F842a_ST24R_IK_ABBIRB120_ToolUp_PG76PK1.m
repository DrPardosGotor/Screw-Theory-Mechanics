%% Function "F842a_ST24R_IK_ABBIRB120_ToolUp_PG76PK1" IK SIMULATION
% ABB IRB120 - Robot ZERO position with Tool-Up.
%
...
%
% function ThetaOut = F842a_ST24R_IK_ABBIRB120_ToolUp_PG76PK1(u)
%
...
% F110_CreateToolTra_Sin([0.1 0.6 0.1 0 pi/2 0], [0.2 0.8 0.2 pi/4 pi pi/4], 0.001, 10)
%
...
%
%% F842a_ST24R_IK_ABBIRB120_ToolUp_PG76PK1
%
function ThetaOut = F842a_ST24R_IK_ABBIRB120_ToolUp_PG76PK1(u) % #codegen
%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
po=[0;0;0]; pf=[0.302;0.630;0]; pp=[0.302;0.790;0];
%
