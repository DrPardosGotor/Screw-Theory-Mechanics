%% Function "F861a_ST24R_ID_ABBIRB120_SVA" - Spatial Vector Algebra.
...
%
% function TorOut = F861b_ST24R_ID_ABBIRB120_SVA(u)
%
...
%
%% F861b_ST24R_ID_ABBIRB120_SVA
%
function TorOut = F861b_ST24R_ID_ABBIRB120_SVA(u) % #codegen
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%po=[0;0;0];
pg=[0; 0; 0.19]; pk=[0; 0; 0.29]; pr=[0; 0; 0.56]; ps=[0; 0; 0.63];
