%% Function "F832_ST24R_FK_ABBIRB120_ToolUp" - FORWARD KINEMATICS SIMULATION
...
%
% function ToolPose = F842_ST24R_FK_ABBIRB120_ToolUp(Theta)
%
...
%
%% F832_ST24R_FK_ABBIRB120_ToolUp
%
function ToolPose = F832_ST24R_FK_ABBIRB120_ToolUp(Theta) % #codegen
%
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
